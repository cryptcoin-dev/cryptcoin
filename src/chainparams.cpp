...
{
    const char* pszTimestamp = "Paul Noonan on life as a music therapist and his electric kazoo";
    const CScript genesisOutputScript = CScript() << ParseHex("0a2184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7a03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 37317600;
        ...
        genesis = CreateGenesisBlock(1623958217, 2000390372, 0x1e0ffff0, 1, 120 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x26b3f12e12d0b81d128501c5166c922ea3704db6550c692f239ce718a30e3a9b"));
        assert(genesis.hashMerkleRoot == uint256S("0x8c47b4b743b9c5c927188221502ffbe94d287837e5634f88aea3fbf939663491"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("34.105.154.208", "34.105.154.208", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("cryptcointools.com", "dnsseed.cryptcointools.com"));
        //vSeeds.push_back(CDNSSeedData("cryptcoinpool.org", "dnsseed.cryptcoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x26b3f12e12d0b81d128501c5166c922ea3704db6550c692f239ce718a30e3a9b"))
        ...
        chainTxData = ChainTxData{
            ...
            1623958217, // * UNIX timestamp of last known number of transactions
    ...
    CTestNetParams() {
      ...
      //  consensus.nMinimumChainWork = uint256S("0x000000000000000000000000000000000000000000000000000000054cb9e7a0");
       ...
       // consensus.defaultAssumeValid = uint256S("0x43a16a626ef2ffdbe928f2bc26dcd5475c6a1a04f9542dfc6a0a88e5fcf9bd4c"); //8711
        ...
        genesis = CreateGenesisBlock(1623958217, 207009, 0x1e0ffff0, 1, 120 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc54172425d30691fcd3ce60dd72c1ed670979c77af360759a8200a24bf5131dc"));
        assert(genesis.hashMerkleRoot == uint256S("0x8c47b4b743b9c5c927188221502ffbe94d287837e5634f88aea3fbf939663491"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("34.105.154.208", "34.105.154.208"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.cryptcoin.loshan.co.uk", true));
       // vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed-testnet.thrasher.io", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xc54172425d30691fcd3ce60dd72c1ed670979c77af360759a8200a24bf5131dc")),
        };
    ...
    CRegTestParams() {
      ...
      //  consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
       ...
       // consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 999999999999ULL;
        ...
        genesis = CreateGenesisBlock(1623958217, 0, 0x207fffff, 1, 120 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x351b9452683f654541f7810d2d92d9819f880f66ba4542291a8db25a7704dcbf"));
        assert(genesis.hashMerkleRoot == uint256S("0x8c47b4b743b9c5c927188221502ffbe94d287837e5634f88aea3fbf939663491"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x351b9452683f654541f7810d2d92d9819f880f66ba4542291a8db25a7704dcbf"))
        };
