...
const char * const BITCOIN_CONF_FILENAME = "cryptcoin.conf";
const char * const BITCOIN_PID_FILENAME = "cryptcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Cryptcoin";
#else
    // Unix
