...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cryptcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cryptcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptcoin transaction") + "\n" +
              "  cryptcoin-tx [options] -create [commands]   " + _("Create hex-encoded cryptcoin transaction") + "\n" +
              "\n";
