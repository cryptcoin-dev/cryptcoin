...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/cryptcoin-project/cryptcoin>";
    const std::string URL_WEBSITE = "<https://cryptcoin.org>";
